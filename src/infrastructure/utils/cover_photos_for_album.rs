    ...
    fn it_should_return_first_featured_landscaped_photo() {
        ...
        album.add_photo(
            AlbumPhoto::new(
                ...
                Utc::now(),
                vec![],
                Image::new(&Path::new("file_1"), "", &MediaDimensions::new(30, 20)),
                Image::new(&Path::new("file_1"), "", &MediaDimensions::new(30, 20)),
                Image::new(&Path::new("file_1"), "", &MediaDimensions::new(30, 20)),
                Utc::now(),
            )
        ...
        album.add_photo(
            AlbumPhoto::new(
                ...
                Utc::now(),
                vec![],
                Image::new(&Path::new("file_2"), "", &MediaDimensions::new(20, 30)),
                Image::new(&Path::new("file_2"), "", &MediaDimensions::new(20, 30)),
                Image::new(&Path::new("file_2"), "", &MediaDimensions::new(20, 30)),
                Utc::now(),
            )
        ...
        album.add_photo(
            AlbumPhoto::new(
                ...
                Utc::now(),
                vec![],
                Image::new(&Path::new("file_3"), "", &MediaDimensions::new(30, 20)),
                Image::new(&Path::new("file_3"), "", &MediaDimensions::new(30, 20)),
                Image::new(&Path::new("file_3"), "", &MediaDimensions::new(30, 20)),
                Utc::now(),
            )
    ...
    fn it_should_return_first_two_featured_portrait_photos() {
        ...
        album.add_photo(
            AlbumPhoto::new(
                ...
                Utc::now(),
                vec![],
                Image::new(&Path::new("file_1"), "", &MediaDimensions::new(20, 30)),
                Image::new(&Path::new("file_1"), "", &MediaDimensions::new(20, 30)),
                Image::new(&Path::new("file_1"), "", &MediaDimensions::new(20, 30)),
                Utc::now(),
            )
        ...
        album.add_photo(
            AlbumPhoto::new(
                ...
                Utc::now(),
                vec![],
                Image::new(&Path::new("file_3"), "", &MediaDimensions::new(20, 30)),
                Image::new(&Path::new("file_3"), "", &MediaDimensions::new(20, 30)),
                Image::new(&Path::new("file_3"), "", &MediaDimensions::new(20, 30)),
                Utc::now(),
            )
